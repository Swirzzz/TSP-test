<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="New_contract.aspx.cs" Inherits="New_contract" %>
        ...
        <table>
            <tr>
                ...
                <td style="width: 390px">
                    <asp:TextBox ID="TxtCname" runat="server" Width="374px"></asp:TextBox>
                </td>
            ...
            <tr>
                ...
                <td style="width: 390px">
                    <asp:TextBox ID="TxtDescription" runat="server" Height="170px" TextMode="MultiLine" Width="381px"></asp:TextBox>
                </td>
                <td style="width: 220px">
            ...
            <tr>
                ...
                <td style="width: 390px; text-align: center;">
                    <asp:Button ID="BtnSubmit" class="btn btn-primary" runat="server" OnClick="BtnSubmit_Click" Text="Submit" ValidationGroup="valGroup" />
                </td>
                <td style="width: 220px">&nbsp;</td>
            </tr>
        </table>
